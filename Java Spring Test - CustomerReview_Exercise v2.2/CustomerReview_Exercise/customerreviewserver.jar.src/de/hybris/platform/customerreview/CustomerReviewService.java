...
public abstract interface CustomerReviewService
{
  ...
  //abstract method to get the total no of reviews based on given rating range
  public abstract Integer getNumberOfReviewsPerRange(ProductModel paramProductModel, int beginValue, int endValue);
